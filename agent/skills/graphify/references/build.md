# graphify reference: build pipeline

Load this reference when running a fresh build (`/graphify`, `/graphify <path>`, `graphify .`), initial extraction, or full graph rebuild. Follow these steps in order. Do not skip steps.
