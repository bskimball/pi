// edit-tool: Pi tool registration and optional Apex receipt for the deep
// EditPlanner in ./planner.ts.
//
// Registration and execution are unconditional; the diff receipt attaches only
// through the Apex presentation gate, so PI_APEX_UI=0 falls back to Pi's stock
// boxed rendering of the model-facing summary.
...
export function installEditTool(pi: ExtensionAPI): void {
  let lastTheme:
