...
export const TOOL_DESCRIPTION = `Edit files with one marked row edit script.
...
export const unifiedEditSchema = {
	type: "object",
...
export interface UnifiedEditDetails extends EditDetailsLike {
	files: Array<{
		path: string;
...
export function prepareUnifiedArguments(args: unknown): UnifiedEditParams {
...
export async function preflightPlan(plan: ParsedPlan, signal?: AbortSignal): Promise<void> {
...
export async function applyPlan(plan: ParsedPlan, signal?: AbortSignal): Promise<UnifiedEditDetails> {
	const appliers = {
...
export function formatSummary(details: UnifiedEditDetails): string {
