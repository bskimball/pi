...
Context gate: Protect the lead's context window. Delegate broad reconnaissance and research to the sidekick when a separate context helps; use the lead's tools directly for focused investigation. Librarian remains manual-only.
